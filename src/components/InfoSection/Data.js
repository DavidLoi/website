...
export const homeObjOne = {
  ...
  description: 'Calculates the optimal path given a starting location, an ending location and any number of locations inbetween.',
...
export const homeObjTwo = {
  ...
  description: 'Gathers historical prices for a selected stock ticker and predicts the price of it after a configurable number of days using statistics and probability theory.',
...
export const homeObjThree = {
  ...
  description: "A Tic Tac Toe game for Android phones that keeps track of each player's score and also has a button to reset the board.",
